...
.as-we-work__content--make-estimate::after {
  background-image: url(../pictures/cost-estimate.jpg) !important;
}

.as-we-work__content--atract-contractors::after {
  background-image: url(../pictures/bring-contractor.jpg) !important;
}

.as-we-work__content--inspecting::after {
  background-image: url(../pictures/inspecting-works.jpg) !important;
}
...
.application-form__input-checkbox:checked+.application-form__check-label::after {
  content: "";
  display: block;
}

.application-form__input-checkbox:focus+.application-form__check-label::before {
...
.question:focus-within .question__icon {
  background-color: var(--primary-color);
}

.question:focus-within .question__icon::before {
  background-color: #FFFFFF;
}

.question:focus-within .question__icon::after {
  background-color: #FFFFFF;
}
...
.question:hover .question__icon::after {
  background-color: #FFFFFF;
}
...
.social-link:hover .index-footer__social-link-color {
...
.social-link:active .index-footer__social-link-color {
  fill: #E1670E;
  outline: none;
}
